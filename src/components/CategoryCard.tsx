...
export const CategoryCard = ({ title, icon: Icon, description }: CategoryCardProps) => {
  return (
    <div className="group cursor-pointer">
      <div className="bg-white p-6 rounded-xl shadow-md transition-all duration-300 hover:shadow-xl group-hover:animate-card-hover border border-medical-light">
